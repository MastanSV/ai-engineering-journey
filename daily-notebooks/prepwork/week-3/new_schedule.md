...
Land an **AI / LLM Engineer** role by **December 2026** by shipping **6 production-grade portfolio projects**, learning in public on [Twitter/X](https://twitter.com/YOUR_HANDLE), and mastering the full stack from **transformers-from-scratch → RAG → agents → fine-tuning → LLMOps**.
...
*Status legend: ⬜ Not started · 🟡 In progress · ✅ Shipped · 🌟 Polished + deployed*

### 📈 Weekly Progress

| Week | Dates | Focus | Retro |
|------|-------|-------|-------|
| 0 | Apr 23 – Apr 26, 2026 | Setup & baseline | [log](weekly-logs/week-00-setup.md) |
| 1 | Apr 27 – May 3        | ML foundations 1 | — |
| 2 | May 4 – May 10        | ML foundations 2 | — |
| … | …                      | …                 | — |

*(Updated every Sunday — commit streak is visible on my profile 🔥)*
...
- 🚀 **Project #5: QLoRA Fine-Tune + Full LLMOps Loop** — fine-tune a 7B-class model (Llama / Qwen / Mistral) on a specific task on local GPU. Full loop: data pipeline → LoRA training → eval vs. base → GGUF quantization → Ollama deployment → Gradio demo on HF → monitoring dashboard → cost/latency report. **💎 Crown jewel.**
...
*Missing 2+ NNs in a week triggers a root-cause retro. No drift allowed.*
...
**Compute:** Local NVIDIA GPU · Google Colab · Kaggle Notebooks  
...
├── concepts/            ← Feynman-style notes in my own words
├── mock-interviews/     ← scores, feedback, transcripts
├── projects/            ← links / submodules to each project repo
└── twitter-posts/       ← drafts before going live
```
...
- 🐦 **Twitter/X:** [@YOUR_HANDLE](https://twitter.com/YOUR_HANDLE) — weekly threads every Friday
- ✍️ **Blog:** *coming soon*
...
*Let's make this the most ruthlessly productive 8 months of our lives.* 🔥